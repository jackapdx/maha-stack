...
## Project Overview
`create-maha-stack` is a high-performance, AI-native CLI tool that scaffolds monorepo architectures. Version **1.6.0**. Published to npm as `create-maha-stack`.
...
## Project State
- **npm Package**: `create-maha-stack` v1.6.0 (https://www.npmjs.com/package/create-maha-stack)
